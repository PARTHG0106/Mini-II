...
def analyze_bicep_curl_video(video_path):
    """
    Analyzes bicep curl video and provides feedback on form
    """
    ...
    with mp_pose.Pose(
        ...
        while cap.isOpened():
            ...
            if results.pose_landmarks:
                ...
                if left_elbow.x < 0.3 or right_elbow.x > 0.7:
                ...
                if abs(left_wrist.x - left_elbow.x) > 0.1 or abs(right_wrist.x - right_elbow.x) > 0.1:
                    feedback.append("Keep your wrists straight")
